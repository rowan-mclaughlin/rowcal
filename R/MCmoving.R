#' Moving Average Time Series for Radiocarbon Dates with a Response Variable (depreciated)
#'
#' This depreciated function computes a moving average time series for radiocarbon (14C) dates
#' associated with a response variable. Its functionality has been replaced by the more flexible `MCrunmed`.
#'
