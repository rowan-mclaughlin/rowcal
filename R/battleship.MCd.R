...
#' @param col Color of the filled area representing the density envelope. Default is semi-transparent blue (`rgb(0, 0, 0.8, 0.5)`).
#' @param lcol Line color for the edges of the density envelope. Default is blue (`rgb(0, 0, 0.8, 0.8)`).
